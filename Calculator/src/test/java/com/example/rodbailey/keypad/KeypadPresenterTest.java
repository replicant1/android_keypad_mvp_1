...
/**
 * Test the CalculatorPresenter, for which we need a mock model and a mock view
 */
public class KeypadPresenterTest {

    @Test
    public void presenterPassesNumericKeyPressesOntoModel() {
        ICalculatorModel mockModel = Mockito.mock(ICalculatorModel.class);
        ICalculatorView mockView = Mockito.mock(ICalculatorView.class);
